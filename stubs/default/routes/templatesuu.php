...
use App\Http\Controllers\Template\LanguageController;
use App\Http\Controllers\Template\DashboardController;
use App\Http\Controllers\Template\AppsController;
use App\Http\Controllers\Template\UserInterfaceController;
use App\Http\Controllers\Template\CardsController;
use App\Http\Controllers\Template\ComponentsController;
use App\Http\Controllers\Template\ExtensionController;
use App\Http\Controllers\Template\PageLayoutController;
use App\Http\Controllers\Template\FormsController;
use App\Http\Controllers\Template\TableController;
use App\Http\Controllers\Template\PagesController;
use App\Http\Controllers\Template\MiscellaneousController;
use App\Http\Controllers\Template\AuthenticationController;
use App\Http\Controllers\Template\ChartsController;
...
// Route::get('/dashboard-ecommerce', [DashboardController::class, 'dashboardEcommerce'])->name('dashboard');
